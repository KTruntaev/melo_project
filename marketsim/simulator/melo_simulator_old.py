    ...
    def step(self):
        ...
        if self.time < self.sim_time:
            ...
            if agents:
                ...
                # BUG (unfixed in melo_simulator_old): meloMarket.step() is NOT called here,
                # so any MELO orders placed by background agents above are stuck in
                # meloMarket.event_queue and never reach the order book unless a
                # strategic melo_agent also arrives this tick to drain the queue.
